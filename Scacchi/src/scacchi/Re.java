...
public class Re extends Pedina {
	...
	public int[][] mossePossibili(Position posPedina, Pedina[][] scacchiera) {
		...
		positions.add(new Position(posPedina.getRiga() + 1, posPedina
				.getColonna())); // avanti o indietro
		positions.add(new Position(posPedina.getRiga() - 1, posPedina
				.getColonna())); // avanti o indietro

		positions.add(new Position(posPedina.getRiga(),
				posPedina.getColonna() + 1)); // dx o sx
		positions.add(new Position(posPedina.getRiga(),
				posPedina.getColonna() - 1)); // dx o sx

		positions.add(new Position(posPedina.getRiga() + 1, posPedina
				.getColonna() + 1)); // diagonale dx o alto o basso
		positions.add(new Position(posPedina.getRiga() - 1, posPedina
				.getColonna() + 1)); // diagonale dx o alto o basso

		positions.add(new Position(posPedina.getRiga() + 1, posPedina
				.getColonna() - 1)); // diagonale sx o alto o basso
		positions.add(new Position(posPedina.getRiga() - 1, posPedina
				.getColonna() - 1)); // diagonale sx o alto o basso
