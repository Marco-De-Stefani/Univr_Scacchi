...
public abstract class Pedina {
	 ...
	 * @param posPedina
	 * @param scacchiera
	 * @return matrice che indica le mosse possibili della pedina 0 se NON si
	 *         può muovere 1 se può fare la mossa 2 se può mangiare
	 */
	public abstract int[][] mossePossibili(Position posPedina,
			Pedina[][] scacchiera);
}
